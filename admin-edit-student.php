...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //Now replace all the text in the old bio.txt with the new bio, if the bio entry was not empty
    if (!empty($bio_in)) {
        ...
        file_put_contents($folder . "/bio.txt", $bio_in); //replace with new text
